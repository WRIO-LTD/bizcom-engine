...
This repository is a **read-only mirror** of the `packages/bizcom-engine` directory in the [webRunes/bizcom-monorepo](https://github.com/webRunes/bizcom-monorepo).
...
3. **Integration**: Approved PRs will be pulled into the `webRunes/bizcom-monorepo` by a maintainer using a specialized sync script.
